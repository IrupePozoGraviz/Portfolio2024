...
export const Main = () => {
  return (
    <main className={styles.mainContainer} role="main" aria-labelledby="main-heading">
      ...
      <div className={styles.desktop}>
        ...
        <div className={styles.profileContainer}>
          <h1 id="main-heading" className={styles.profileH1}>Irupé Pozo Graviz</h1>
          ...
          <p>
            ...
            Hire me as a consultant or as a member of your team.
          </p>
        </div>
      </div>
      ...
      <div className={styles.icons}>
        <div className={styles.iconsGithub}>
          <Link href="https://github.com/IrupePozoGraviz" aria-label="Visit Irupé's GitHub " target="_blank" rel="noopener noreferrer">
  
              <Image src="/assets/blackGithub.svg" alt="GitHub profile link" width={40} height={40} />
       
          </Link>
        </div>

        <div className={styles.iconsLinkedin}>
          <Link href="https://www.linkedin.com/in/irup%C3%A9-pozo-graviz-119112266/" aria-label="Visit Irupé's LinkedIn " target="_blank" rel="noopener noreferrer">
              <Image src="/assets/blacklinkedinicon.svg" alt="LinkedIn profile link" width={40} height={40} />
            </Link>
        </div>
      </div>
    </main>
